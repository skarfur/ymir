...
// Ports handbook.gs's deleteHandbookContact_ — admin only. Soft-delete
// (active=false), matching the original.
...
Deno.serve(async (req: Request) => {
  ...
  const ok = await softDeleteConfigListItem(admin, "handbookContacts", id);
