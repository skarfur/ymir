      ...
      <div class="trip-body">
        <div class="trip-headline">
          ...
          <span class="trip-badges-r">
            ...
            ${hasVerifyPending?'<span class="trip-badge" style="background:color-mix(in srgb, var(--navy-l) 12%, transparent);border:1px solid var(--navy-l);color:var(--navy-l)">'+icon('hourglass')+' '+s('tc.verificationPending')+'</span>':''}
