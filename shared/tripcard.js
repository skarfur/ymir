      ...
      <div class="trip-body">
        <div class="trip-headline">
          ...
          <span class="trip-badges-r">
            ...
            ${hasPendingBadge?'<span class="trip-badge" style="background:var(--yellow)11;border:1px solid var(--yellow)55;color:var(--yellow)">'+icon('hourglass')+' '+s('tc.pending')+'</span>':''}
            ${hasVerifyPending?'<span class="trip-badge badge-verify-pending" title="'+esc(s('tc.verificationPending'))+'" aria-label="'+esc(s('tc.verificationPending'))+'">'+icon('shield-question-mark')+'</span>':''}
            ...
            ${isVer?'<span class="trip-badge badge-verified" title="'+esc(s('lb.stat.verified'))+'" aria-label="'+esc(s('lb.stat.verified'))+'">'+icon('shield-check')+'</span>':''}
