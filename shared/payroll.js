...
function punchClockWidget(el, employeeId, opts) {
  ...
  if (!document.getElementById('pcStyle')) {
    ...
    st.textContent =
      ...
      '.pc-btn-brk{background:var(--surface);border:1px solid var(--accent);color:var(--accent-fg)}' +
      '.pc-btn-brk-end{background:var(--accent);color:#0b1f38}' +
      ...
      '.pc-modal-title{font-size:14px;font-weight:600;color:var(--accent-fg);margin-bottom:4px;letter-spacing:.3px}' +
