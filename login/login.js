...
// Migration diagnostic — exercises the real Supabase login -> whoami round
// trip using whatever is currently in the username/password fields. Never
// calls setSession/proceedWithUser: the two backends don't share sessions
// yet (Apps Script's sessions sheet has no idea Supabase's sessions table
// exists, and vice versa), so wiring this into the real flow would break
// every subsequent apiGet/apiPost call once redirected into the app. This
